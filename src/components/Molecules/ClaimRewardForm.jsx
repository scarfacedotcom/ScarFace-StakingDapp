...
export const ClaimRewardForm = () => {
  ...
  return (
    <form
      ...
      className="relative flex flex-col mt-4 px-8 py-8 w-1/2 m-auto bg-zinc-50 shadow-2xl shadow-zinc-200 rounded-lg ring-1 ring-zinc-200"
    >
      <div className="">
      ...
      <div className="mb-8">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <label className=" text-sm">Claim Reward</label>
            <input
              type="text"
      ...
      <button
        type="submit"
        className="w-full bg-zinc-800 text-white rounded-md p-2 hover:bg-zinc-900"
      >
        Claim Reward
      </button>
    </form>
